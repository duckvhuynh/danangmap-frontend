...
export default function EditorMapCanvas({ activeTool, restore, onSnapshot, onError }: { activeTool: DrawTool; restore: RestoreRequest; onSnapshot: (features: unknown[]) => void; onError: (message: string) => void }) {
