  ...
  return (
    <main className="grid min-h-[100dvh] bg-surface-subtle lg:grid-cols-[1fr_520px]">
      <section className="relative hidden overflow-hidden border-r bg-accent-subtle p-12 lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground"><IconShieldCheck className="text-success" strokeWidth={1.75} />Kết nối được bảo vệ · Tài khoản nội bộ</div>
      </section>
      <section className="flex items-center justify-center bg-surface p-5 sm:p-10">
        <div className="w-full max-w-sm">
          ...
          <div className="grid size-11 place-items-center rounded-map-control bg-accent-subtle text-primary"><IconLock strokeWidth={1.75} /></div>
          ...
          <LoginForm />
          <BootstrapSetupLink />
          <Button asChild variant="ghost" className="mt-8 -ml-3"><Link href="/"><IconArrowLeft strokeWidth={1.75} />Quay lại bản đồ</Link></Button>
        </div>
      </section>
    </main>
  );
